...
public class ScreenActivity extends ActionBarActivity implements OnGestureListener, NavigationDrawerFragment.NavigationDrawerCallbacks, DateSetListener
																		{
...
//			loadCostList(currentWeek);
	...
	public void onNavigationDrawerItemSelected(int position) {
		...
		case 3:
			...
			break;
		case 4:
			i = new Intent(getApplicationContext(),ScreenActivity.class);
			startActivityForResult(i, IConstant.PARENT_ACTIVITY_REQUEST_CODE);
			break;
		case 5:
	...
	AnimatorListener animatorListener = new AnimatorListener() {
		...
		public void onAnimationStart(Animator arg0) {
			mProgressDialog = ProgressDialog.show(ScreenActivity.this, "Please wait ...", "Loading...", true);
